...
public class PointVenteApi {
    ...
    @GetMapping
    public ResponseEntity<List<PointVenteDto>> getAll(@RequestParam(value = "pageNum", required = false) Integer pageNum, @RequestParam(value = "size", required = false) Integer size) {
    ...
    public ResponseEntity<List<PointVenteEntreprise>> getAllByEntreprise() {
        log.trace("Starting processing getAll request!");
    ...
    public ResponseEntity<List<PointVenteDto>> getByOrganisation(@PathVariable("organisationId") Integer organisationId) {
        log.trace("Starting processing getAll request!");
    ...
    @PostMapping()
    public ResponseEntity<PointVenteDto> save(@RequestBody PointVenteDto pointVenteDto) {
    ...
    @PutMapping(path = "/{id}")
    public ResponseEntity<PointVenteDto> update(@PathVariable Integer id, @RequestBody PointVenteDto pointVenteDto) {
